...
export default function Body({ dishElements, Forms, createNewFood, showUpdateForm, showAddForm, handleShowAddForm, fireBaseHandleSubmit}) {
    return (
        <main className='body--main-container'>
            <section className='main--landing container-fluid mt-4'>
                <div className='main--content text-white fs-5 fw-light'>
                    ...
                    <br />
                    <button type='button' onClick={fireBaseHandleSubmit}>Test</button>
